...
This is the sole provenance ledger; the retired 7.2 `linux-sleepy` series
(the same kernel project's earlier era, dropped 2026-09-02) is archived in
`PATCH_SOURCES-7.2.md`.
