...
EOF
    ...
    for patch in "${source[@]}"; do
        ...
        if [[ "$patch" == "${_patchsource}"/misc/nvidia/* ]]; then
            patch -Np1 --forward < "../${patch}" -d "${srcdir}/${_nv_open_pkg}"
        else
    ...
    patch -Np1 --forward -R -i "$srcdir/patches/1100-1199/1101-drm-amd-display-enable-pstate-for-dcn4-non-emulation-builds.patch"
