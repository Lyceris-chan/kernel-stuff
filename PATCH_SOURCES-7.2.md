# Patch source manifest — linux-sleepy 7.2 (ARCHIVED)

> **Retired 2026-09-02.** This is the provenance ledger for the 7.2
> `linux-sleepy` kernel package, which was dropped in favor of the single
> `linux-sleepy-next` package (linux-next 7.3 preview). The live ledger is
> `PATCH_SOURCES.md`; this archive is kept for provenance of the shared
> 7.2-era patches that the sleepy-next series descended from.
